...
const en = {
  ...
  loginLead: "Sign in with Yahoo Mail to look up traveller declarations.",
  adminTitle: "Declarations",
  searchPlaceholder: "Search name, passport, Civil ID or code",
  reportsEmail:
    "Each submitted declaration is emailed to k_hmed@yahoo.com. Open the first message and click Confirm so later reports arrive.",
  risk: "Follow-up",
  clear: "Clear",
  ...
  staffEmail: "Yahoo Mail",
  staffPassword: "Yahoo account password for this site",
  ...
  orContinue: "or",
  loginFailed: "Could not sign in with Yahoo. Check the address and password.",
  yahooSignIn: "Sign in with Yahoo Mail",
  yahooOnly: "Staff login is Yahoo Mail only (k_hmed@yahoo.com).",
...
const ar: Record<Msg, string> = {
  ...
  loginLead: "سجّل الدخول ببريد ياهو للاطلاع على إقرارات المسافرين.",
  adminTitle: "الإقرارات",
  searchPlaceholder: "بحث بالاسم أو الجواز أو الرقم المدني أو الرمز",
  reportsEmail:
    "يُرسل كل إقرار مقدَّم إلى k_hmed@yahoo.com. افتح الرسالة الأولى واضغط تأكيد حتى تصل التقارير التالية.",
  risk: "متابعة",
  clear: "سليم",
  ...
  staffEmail: "بريد ياهو",
  staffPassword: "كلمة مرور حساب ياهو لهذا الموقع",
  ...
  orContinue: "أو",
  loginFailed: "تعذر الدخول بياهو. تحقق من العنوان وكلمة المرور.",
  yahooSignIn: "تسجيل الدخول ببريد ياهو",
  yahooOnly: "دخول الموظفين عبر بريد ياهو فقط (k_hmed@yahoo.com).",
