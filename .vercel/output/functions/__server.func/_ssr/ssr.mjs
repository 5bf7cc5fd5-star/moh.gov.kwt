...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-cvZHSICr.mjs");
...
var manifest = {
	"bd554b77665b2494cfc02aad9d62d82c4dc44f2afec67fd0128ea78944226324": {
		functionName: "getDeclarationByCode_createServerFn_handler",
		importer: () => import("./declarations-BQNHPHXO.mjs")
	},
	"bf5c5e4e330e2e000a2703e8a8b86a64754c6b8a89be738a8868ead5d800ba99": {
		functionName: "searchDeclarations_createServerFn_handler",
		importer: () => import("./declarations-BQNHPHXO.mjs")
	},
	"e9d65dfeed829914afee2eab9daaf45ba4aabc8da1aac310d7182cdd2643b575": {
		functionName: "submitDeclaration_createServerFn_handler",
		importer: () => import("./declarations-BQNHPHXO.mjs")
	}
};
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-eMpGfEv6.mjs").then((n) => n.t),
